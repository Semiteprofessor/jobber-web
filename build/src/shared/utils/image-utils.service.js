export const validateImage = (file, type) => {
    if (type === 'image') {
...
export const checkImageSize = (file, type) => {
    let fileError = '';
...
export const checkImage = (file, type) => {
    let isValid = true;
...
export const checkUrlExtension = (fileExtension) => {
    let fileType = '';
